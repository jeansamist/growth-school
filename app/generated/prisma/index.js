  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgres://growthschools:npg_fOlRqZt7gQ9V@server11.vps.webdock.cloud/growth_schools_db?connect_timeout=15"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Category {\n  id    Int    @id @default(autoincrement())\n  cover String\n  name  String\n  items Item[]\n}\n\nmodel Tag {\n  id    Int         @id @default(autoincrement())\n  cover String\n  name  String\n  items TagOnItem[]\n}\n\nmodel Item {\n  id           Int           @id @default(autoincrement())\n  title        String\n  description  String\n  price        Int\n  cover        String\n  discount     Int?\n  testimonials Testimonial[]\n  ebook        Ebook?\n  training     Training?\n  categoryId   Int\n  files        File[]\n  category     Category      @relation(fields: [categoryId], references: [id])\n  tags         TagOnItem[]\n}\n\nmodel Ebook {\n  id       Int     @id @default(autoincrement())\n  author   String?\n  isbn     String?\n  language String?\n  pages    Int?\n  edition  String?\n  date     String?\n  itemId   Int     @unique\n  item     Item    @relation(fields: [itemId], references: [id])\n}\n\nmodel Training {\n  id      Int     @id @default(autoincrement())\n  modules String?\n  itemId  Int     @unique\n  item    Item    @relation(fields: [itemId], references: [id])\n}\n\nmodel Testimonial {\n  id      Int    @id @default(autoincrement())\n  name    String\n  message String\n  itemId  Int\n  item    Item   @relation(fields: [itemId], references: [id])\n}\n\nmodel TagOnItem {\n  itemId Int\n  item   Item @relation(fields: [itemId], references: [id])\n  tagId  Int\n  tag    Tag  @relation(fields: [tagId], references: [id])\n\n  @@id([itemId, tagId])\n}\n\nmodel File {\n  id     Int     @id @default(autoincrement())\n  title  String?\n  url    String\n  itemId Int\n  item   Item    @relation(fields: [itemId], references: [id])\n}\n",
  "inlineSchemaHash": "855c762068746522c1741d424f9e96feb490e7f4bffcc81531b8599b68b8a14a",
  "copyEngine": true
}

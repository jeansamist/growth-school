...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\jeans\\Documents\\GitHub\\growth-school\\app\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\jeans\\Documents\\GitHub\\growth-school\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgres://neondb_owner:npg_fOlRqZt7gQ9V@ep-still-mud-a2mrfy5h-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Category {\n  id    Int    @id @default(autoincrement())\n  cover String\n  name  String\n  items Item[]\n}\n\nmodel Tag {\n  id    Int         @id @default(autoincrement())\n  cover String\n  name  String\n  items TagOnItem[]\n}\n\nmodel Item {\n  id           Int         @id @default(autoincrement())\n  title        String\n  description  String\n  price        Int\n  cover        String\n  files        File[]\n  discount     Int?\n  categoryId   Int\n  author       String?\n  isbn         String?\n  language     String?\n  modules      String?\n  testimonials String?\n  pages        Int?\n  edition      String?\n  date         String?\n  category     Category    @relation(fields: [categoryId], references: [id])\n  tags         TagOnItem[]\n}\n\nmodel TagOnItem {\n  itemId Int\n  item   Item @relation(fields: [itemId], references: [id])\n  tagId  Int\n  tag    Tag  @relation(fields: [tagId], references: [id])\n\n  @@id([itemId, tagId])\n}\n\nmodel File {\n  id     Int     @id @default(autoincrement())\n  title  String?\n  url    String\n  itemId Int\n  item   Item    @relation(fields: [itemId], references: [id])\n}\n",
  "inlineSchemaHash": "40225c374dd8c87c8b73027cef32d6a0700b57dd61772cada82cbb30d558b0d1",
  "copyEngine": true
}
